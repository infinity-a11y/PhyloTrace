...
if(!is.null(selected_elements[["scheme"]][[2]][2])){
...
if(!is.null(report_vars[["na_handling"]])){
  df <- data.frame(Item = c(if(report_vars[["report_df.Include"]][9]){"Tree construction"},
                 ...
                 Content = c(if(report_vars[["report_df.Include"]][9]){report_vars[["tree"]]},
